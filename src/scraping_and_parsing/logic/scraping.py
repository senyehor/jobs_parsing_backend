...
from src.scraping_and_parsing.sites import Playwright_SITES, SELENIUM_SITES, SiteBase
...
filter_selenium_sites = partial(_filter_sites_dict_by_slug, sites=SELENIUM_SITES)
filter_httpx_sites = partial(_filter_sites_dict_by_slug, sites=SELENIUM_SITES)
